...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 02, 2019 at 06:41 PM
...
INSERT INTO `company` (`id`, `company_name`, `address`, `phone`, `email`, `password`) VALUES
(1, 'Training Data', '241, Fake Street, Fake Town.', '0114589652', 'training@vacancy.com', ''),
(2, 'Test Compnay', '34,Fake Street, Town', '0458965758', 'info@test.lk', 'test'),
(3, 'ABC', '23,Fk Street', '0115442563', 'info@abc.com', 'abc');
...
(45, 50, 25, '\"                     \\r\\n\\t\\t\\t\\t\\t\\t\\t[\'c\', \'java\', \'php\', \'javascript\', \'css\', \'mongodb\', \'mysql\']\\r\\n\\t\\t\\t\\t\\t\\t\\t\\r\\n                \"', '                  \r\n							Software Development Internship\r\n							\r\n							professionals to gain knowledge and improve my skills by giving\r\n							\r\n							Development using REST\r\n							\r\n							knowledge up to date.\r\n							\r\n							?  Technologies used:   MEAN Stack, REST services, GitHub,\r\n							\r\n							?  Technologies used:   MEAN Stack, REST services, GitHub, WSO2 ESB ,\r\n							\r\n							Sensor emulator program is used to send randomly generated data to the\r\n							\r\n							This is a News application which can perform User Authentication and Registration\r\n							\r\n							for users and also performs CRUD operations of News item using MVC architecture.\r\n							\r\n							http:ashenjay.blogspot.com201707simple-crud-application-with-user.html\r\n							\r\n							?  Technologies used:  HTML5, CSS 3, JavaScript, JQuery, MySQL, PHP,\r\n							\r\n							Technologies  used:  JavaSE,  MSSQL  Management  Studio,  NetBeans,\r\n							\r\n							?        Technologies used:  C#, Visual Studio 10\r\n							\r\n                ', ' ', '                    \r\n							Sri Lanka Institute of Information Technology\r\n							\r\n                ', '                     \r\n							B.Sc Special (Hons) in Information Technology\r\n							\r\n                ', '                  \r\n							B.Sc Special (Hons) in Information Technology\r\n							\r\n                ', '[\" \"]', 0, 0),
(46, 51, 25, '\"C,Java,Php,Javascript,CSS,Mongodb,Mysql\"', '                  \r\n							Software Development Internship\r\n							\r\n							professionals to gain knowledge and improve my skills by giving\r\n							\r\n							Development using REST\r\n							\r\n							knowledge up to date.\r\n							\r\n							?  Technologies used:   MEAN Stack, REST services, GitHub,\r\n							\r\n							?  Technologies used:   MEAN Stack, REST services, GitHub, WSO2 ESB ,\r\n							\r\n							Sensor emulator program is used to send randomly generated data to the\r\n							\r\n							This is a News application which can perform User Authentication and Registration\r\n							\r\n							for users and also performs CRUD operations of News item using MVC architecture.\r\n							\r\n							http:ashenjay.blogspot.com201707simple-crud-application-with-user.html\r\n							\r\n							?  Technologies used:  HTML5, CSS 3, JavaScript, JQuery, MySQL, PHP,\r\n							\r\n							Technologies  used:  JavaSE,  MSSQL  Management  Studio,  NetBeans,\r\n							\r\n							?        Technologies used:  C#, Visual Studio 10\r\n							\r\n                ', ' ', 'Sri Lanka Institute of Information Technology\r\n							\r\n                ', 'BSc Special (Hons) in Information Technology', 'IT', '[\" \"]', 0, 0),
(47, 52, 25, '\"C,Java,Php,Javascript,CSS,Mongodb,Mysql\"', '                  \r\n							Software Development Internship\r\n							\r\n							professionals to gain knowledge and improve my skills by giving\r\n							\r\n							Development using REST\r\n							\r\n							knowledge up to date.\r\n							\r\n							?  Technologies used:   MEAN Stack, REST services, GitHub,\r\n							\r\n							?  Technologies used:   MEAN Stack, REST services, GitHub, WSO2 ESB ,\r\n							\r\n							Sensor emulator program is used to send randomly generated data to the\r\n							\r\n							This is a News application which can perform User Authentication and Registration\r\n							\r\n							for users and also performs CRUD operations of News item using MVC architecture.\r\n							\r\n							http:ashenjay.blogspot.com201707simple-crud-application-with-user.html\r\n							\r\n							?  Technologies used:  HTML5, CSS 3, JavaScript, JQuery, MySQL, PHP,\r\n							\r\n							Technologies  used:  JavaSE,  MSSQL  Management  Studio,  NetBeans,\r\n							\r\n							?        Technologies used:  C#, Visual Studio 10\r\n							\r\n                ', ' ', 'Sri Lanka Institute of Information Technology\r\n							\r\n                ', 'BSc Special (Hons) in Information Technology', 'IT', '[\" \"]', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cv_reg`
--
...
--
-- Dumping data for table `cv_reg`
--

INSERT INTO `cv_reg` (`id`, `email`, `password`) VALUES
('50', 'ramesh030896@gmail.com', 'abc'),
('52', 'ramesh030896@gmail.com', 'qwe'),
('52', 'ramesh030896@gmail.com', 'qwe');
...
INSERT INTO `user` (`id`, `age`, `name`, `address`, `nic`, `email`, `phone`, `experience`) VALUES
(1, 18, '', '', '', '', 0, ''),
(2, 20, '', '', '', '', 0, ''),
(3, 25, '', '', '', '', 0, ''),
(4, 30, '', '', '', '', 0, ''),
...
(50, 25, 'TESTID', '                  \r\n                ', '               ', '                  \r\n							0772784459 •  jayasinghe.ashen@gmail.com\r\n							\r\n                ', 0, '                  \r\n							company. At the same time, I could learn under working\r\n							\r\n							?  Demonstrated experience\r\n							\r\n							Academic Experiences  Projects\r\n							\r\n                '),
(51, 25, 'AshenJayasinghe', 'M.K Wijayarathna, Thotagamuwa, Hikkaduwa', '94567895685V', 'jayasinghe.ashen@gmail.com\r\n							\r\n                ', 772784459, '                  \r\n							company. At the same time, I could learn under working\r\n							\r\n							?  Demonstrated experience\r\n							\r\n							Academic Experiences  Projects\r\n							\r\n                '),
(52, 25, 'AshenJayasinghe', 'M.K Wijayarathna, Thotagamuwa, Hikkaduwa', '94567895685V', 'jayasinghe.ashen@gmail.com\r\n							\r\n                ', 772784459, '                  \r\n							company. At the same time, I could learn under working\r\n							\r\n							?  Demonstrated experience\r\n							\r\n							Academic Experiences  Projects\r\n							\r\n                ');
...
('20', '1', 'Senior Software Engineer', 'BSc in Computer Science,Information Technology or equivalent professional qualification', '', '3+', 'JavaScript,HTML,CSS,OOP,MVC,MVVM,JQuery,Angular,React,Riot,Typescript,Webpack,RESTful API,Sass,LESS', 'Ability to work within deadlines,Problem solving and communication skills,Ability to learn new technologies quickly,Ability to understand the importance of customer service,Innovative and forward thinking', 0),
